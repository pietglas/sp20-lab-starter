...
mapHelper:
    ...
    beq t1, x0, recurse # if a null pointer, move to next node

mapLoop:
    lw a0, 0(t1)        # load the value at that address into a0
    
    # save temporary values on stack
    addi sp, sp, -8
    sw t0, 0(sp)
    sw t1, 4(sp)
...
recurse:
    ...
    add a1, s1, x0      # put address of the function back into a1 for the recursion
    j  mapHelper        # recurse
